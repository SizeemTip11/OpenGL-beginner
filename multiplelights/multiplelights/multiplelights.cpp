...
int main()
{
	...
	Shader shader("C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/shaders/shader.vs", "C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/shaders/shader.fs");
	Shader lightingshader("C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/lightingshaders/lightingshader.vs", "C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/lightingshaders/lightingshader.fs");
	float vertices[] = {
	...
	unsigned int diffusemap = loadTexture("C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/container2.png");
	unsigned int specularmap = loadTexture("C:/Users/admin/OneDrive/Desktop/Projects/multiplelights/container2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.setVec3("dirLight.diffuse", 0.4, 0.4f, 0.4f);
		shader.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);

		shader.setVec3("pointLights[0].pos", lightPoss[0]);
		shader.setFloat("pointLights[0].constant", 1.0f);
		shader.setFloat("pointLights[0].linear", 0.045f);
		shader.setFloat("pointLights[0].quadratic", 0.0075f);
		shader.setVec3("pointLights[0].ambient", lightPoss[0].x * 0.1, lightPoss[0].y * 0.1, lightPoss[0].z * 0.1);
		shader.setVec3("pointLights[0].diffuse", lightPoss[0]);
		shader.setVec3("pointLights[0].specular", lightPoss[0]);

		shader.setVec3("pointLights[1].pos", lightPoss[1]);
		...
		shader.setVec3("pointLights[2].pos", lightPoss[2]);
		...
		shader.setFloat("spotLight.outer", glm::cos(glm::radians(17.5f)));
		...
		{
			glm::mat4 model = glm::mat4(1.0f);
			model = glm::translate(model, lightPoss[i]);
